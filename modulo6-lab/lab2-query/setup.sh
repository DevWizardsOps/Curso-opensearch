...
# =============================================================================
# Lab 2 — Filter vs Query Context: Setup
# Cria o índice lab2-produtos e indexa o dataset padrão
# =============================================================================
...
index_dataset() {
  ...
  # Substitui "_index": "produtos" por "_index": "lab2-produtos" antes de enviar
  local bulk_data
