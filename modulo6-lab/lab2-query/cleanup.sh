...
# =============================================================================
# Lab 2 — Filter vs Query Context: Cleanup
...
echo ""
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  Lab 2 — Filter vs Query Context       ${NC}"
...
echo ""
success "Cleanup do Lab 2 concluído. Todos os recursos foram removidos."
echo ""
