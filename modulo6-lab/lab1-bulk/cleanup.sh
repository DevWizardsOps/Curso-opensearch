...
# =============================================================================
# Lab 1 — Bulk Indexing: Cleanup
# Remove o índice lab1-produtos e arquivos temporários
# =============================================================================
...
echo ""
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  Lab 1 — Bulk Indexing: Cleanup         ${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""

check_env

# Deleta o índice lab1-produtos
...
# Remove arquivo de resultado temporário
...
echo ""
success "Cleanup do Lab 1 concluído. Todos os recursos foram removidos."
echo ""
